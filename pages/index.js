...
const linkItems = [
  ...
  },
  {
    ...
    color: '#fff',
    bg: '#0077b5',
    url: 'https://www.linkedin.com/in/monika-paliwal-5a1313201/',
  },
  {
    heading: '@mona-paliwal',
  ...
  {
    heading: '@its_me_monikapaliwal',
    subtext: 'Follow on Instagram',
    icon: <AiOutlineInstagram size={36} />,
    color: '#fff',
    bg: '#E4405F',
    url: 'https://www.instagram.com/its_me_monikapaliwal/',
  },
];
